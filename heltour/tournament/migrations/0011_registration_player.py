# Generated by Django 4.2.21 on 2025-06-23 16:38
...
def revert_player(apps, schema_editor):
    Registration = apps.get_model("tournament", "Registration")
    for reg in Registration.objects.all():
        reg.player = None
        reg.save()

def delete_lichess_username(apps, schema_editor):
    Registration = apps.get_model("tournament", "Registration")
    for reg in Registration.objects.all():
        reg.lichess_username = None
        reg.save()


def revert_lichess_username(apps, schema_editor):
    Registration = apps.get_model("tournament", "Registration")
    for reg in Registration.objects.all():
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunPython(code=create_player, reverse_code=revert_player),
        ...
        #        migrations.RunPython(
            #code=delete_lichess_username,
            #reverse_code=revert_lichess_username
            #        ),
